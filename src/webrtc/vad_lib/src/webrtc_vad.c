...
extern WebRtc_Word16 WebRtcVad_get_version(char *version, size_t size_bytes)
{
...
extern WebRtc_Word16 WebRtcVad_AssignSize(int *size_in_bytes)
{
    *size_in_bytes = sizeof(VadInstT) * 2 / sizeof(WebRtc_Word16);
    return 0;
}

extern WebRtc_Word16 WebRtcVad_Assign(VadInst **vad_inst, void *vad_inst_addr)
{
...
extern WebRtc_Word16 WebRtcVad_Create(VadInst **vad_inst)
{
...
extern WebRtc_Word16 WebRtcVad_Free(void *vad_inst)
{
...
extern WebRtc_Word16 WebRtcVad_Init(VadInst *vad_inst)
{
...
extern WebRtc_Word16 WebRtcVad_set_mode(VadInst *vad_inst, WebRtc_Word16 mode)
{
    VadInstT* vad_ptr;
...
extern WebRtc_Word16 WebRtcVad_Process(VadInst *vad_inst,
                                WebRtc_Word16 fs,
